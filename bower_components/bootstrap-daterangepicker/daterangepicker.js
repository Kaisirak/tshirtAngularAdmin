    ...
    DateRangePicker.prototype = {
        ...
        move: function () {
            ...
            if (this.parentEl.is('body')) {
                ...
                console.log(this.parentEl.offset().top);
            }
            ...
            if (this.opens == 'left') {
                ...
                this.container.css({
                    top: -1 * ($(".page").offset().top - this.parentEl.offset().top) + 40,
                    left: -1 * ($(".page").offset().left - this.parentEl.offset().left),
                    right: 'auto'
                });
