      ...
      addBg = function(path) {
        ...
        .directive('fabricCanvas', function() {
			return ({
              ...
              var myBorder = new fabric.Rect({ top: 99, left: 159, width: 202, height: 402, draggable: false, fill: 'transparent', strokeWidth: 1, stroke: '#fff' });
              canvas.add(myBorder);
              var myExtraBorder = new fabric.Rect({ top: 100, left: 160, width: 200, height: 400, draggable: false, fill: 'transparent', strokeWidth: 1, stroke: '#333'});
